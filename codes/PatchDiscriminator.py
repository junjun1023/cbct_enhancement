...
class PatchDiscriminator(nn.Module):
    ...
    def __init__(self, input_nc, ndf=64, n_layers=3, norm_layer=nn.BatchNorm2d,
        ...
        self.conv1 = nn.Conv2d(input_nc, ndf, kernel_size=kernel_size, stride=2, padding=pading)
        ...
        self.conv2 = nn.Conv2d(ndf * nf_mult, 1, kernel_size=kernel_size, stride=1, padding=pading)
