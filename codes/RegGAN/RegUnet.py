...
# local
from .Layer import DownBlock, Conv, ResnetTransformer
...
class Reg(nn.Module):
    def __init__(self, height, width, in_channels_a, in_channels_b, device="cpu"):
        ...
        self.device = device
        self.offset_map = ResUnet(self.in_channels_a, self.in_channels_b, cfg='A', init_func=init_func, init_to_identity=init_to_identity).to(self.device)
