...
def get_training_augmentation():
        train_transform = [
                ...
                albu.CenterCrop(height=280, width=384, always_apply=True),
                ...
                albu.PadIfNeeded(min_height=280, min_width=384, always_apply=True, border_mode=0),
        ]
...
def get_validation_augmentation():
        ...
        test_transform = [
                ...
                albu.CenterCrop(height=280, width=384, always_apply=True),
                albu.LongestMaxSize(max_size=384, interpolation=cv2.INTER_LINEAR_EXACT, always_apply=True),
                albu.PadIfNeeded(280, 384, always_apply=True, border_mode=0)
        ]
